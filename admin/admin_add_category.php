...
include('includes/config.php');
    if(isset($_POST['create_Book_category']))
{
    $name=$_POST['name'];
...
//sql to inset the values to the database
    $query="insert into book_category (name, description) values(?,?)";
    $stmt = $mysqli->prepare($query);
    //bind the submitted values with the matching columns in the database.
    $rc=$stmt->bind_param('ss', $name, $description);
    $stmt->execute();
    //if binding is successful, then indicate that a new value has been added.
    echo"<script>alert('Success! Added New Book Category ');</script>";
}
?>
                            ...
                            <div class="sparkline12-list shadow-reset mg-t-30">
                                <div class="sparkline12-hd">
                                    <div class="main-sparkline12-hd">
                                        <h1>Fill All Book  Category bDetails:</h1>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <div class="login-horizental cancel-wp pull-left">
                                                                            ...
                                                                            <button class="btn btn-sm btn-primary login-submit-cs" type="submit" name="create_Book_category">Add Category</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
