...
<nav id="sidebar">
                ...
                <div class="left-custom-menu-adp-wrap">
                    <ul class="nav navbar-nav left-sidebar-menu-pro">
                        <li class="nav-item">
                            <a href="admin_dashboard.php" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-home"></i> <span class="mini-dn">Home</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
                            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                                <a href="admin_dashboard.php" class="dropdown-item">Admin Dashboard</a>
                                
                            </div>
                        </li>
                        <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-user"></i> <span class="mini-dn">Librarians</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
                            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                                <a href="admin_add_librarian.php" class="dropdown-item">Add </a>
                                <a href="admin_view_librarian.php" class="dropdown-item">View</a>
                                <a href="admin_manage_librarian.php" class="dropdown-item">Manage</a>
                            </div>
                        </li>
                        <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-users"></i> <span class="mini-dn">Library Users</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
                            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                                <a href="admin_add_lib_users.php" class="dropdown-item">Add</a>
                                <a href="admin_view_lib_users.php" class="dropdown-item">View</a>
                                <a href="admin_manage_lib_users.php" class="dropdown-item">Manage</a>
                                <a href="admin_approve_lib_users_acc.php" class="dropdown-item">Approve Accounts</a>
                            </div>
                        </li>
                        <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-book"></i> <span class="mini-dn">Books</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
                            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                                <a href="admin_ad_book.php" class="dropdown-item">Add Book</a>
                                <a href="admin_view_book.php" class="dropdown-item">View</a>
                                <a href="admin_manage_book.php" class="dropdown-item">Manage</a>
                                <a href="admin_add_category.php" class="dropdown-item">Add  Categories</a>
                                <a href="admin_manage_category.php" class="dropdown-item">Manage Categories</a>
                            </div>
                        </li>
