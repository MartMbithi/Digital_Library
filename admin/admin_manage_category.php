                                        ...
                                        <table class="table border-table">
                                            ...
                                            <tbody>
                                                ...
                                                <td><?php echo $cnt;?></td>
                                                    ...
                                                    <td><a  class="fa fa-trash-o" href='admin_manage_category.php?del=<?php echo $row->id;?>' onClick= "return confirm('Remove  This Record?');"></a>
                                                    <a  class="fa fa-check-circle"  href='admin_update_category_record.php?id=<?php echo $row->id;?>'></a></td>
