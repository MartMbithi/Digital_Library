<?php 
    ...
    if(isset($_POST['report_lost']))
    {
        ...
        {
            $success = "Book Reported Lost" && header("refresh:1;url=pages_staff_library_operations_lost_book.php");
        }
        else 
        {
     ...
     <!--Breadcrums-->
            <div id="top_bar">
                <ul id="breadcrumbs">
                    ...
                    <li><a href="pages_staff_library_operations_lost_book.php">Library Operations</a></li>
