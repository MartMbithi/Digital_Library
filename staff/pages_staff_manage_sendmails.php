    ...
    <div id="page_content">
        ...
        <div id="top_bar">
            <ul id="breadcrumbs">
                ...
                <li><span>View Send Mails</span></li>
            </ul>
        </div>
            ...
            <div class="md-card-list-wrapper" id="mailbox">
                <div class="uk-width-large-8-10 uk-container-center">
                    <div class="md-card-list">
                        <div class="md-card-list-header heading_list">Send Mail</div>
                        <div class="md-card-list-header md-card-list-header-combined heading_list" style="display: none">
                            All Send Mails
                        </div>
                        <!--Start Messanges-->
                            <?php
                                $ret="SELECT * FROM  iL_sendMails WHERE sm_senderName = 'Library Staff' "; 
                                $stmt= $mysqli->prepare($ret) ;
                                //$stmt->bind_param('i', $SentMail);
                                $stmt->execute() ;//ok
                                $res=$stmt->get_result();
                                ...
                                <ul class="hierarchical_slide">
                                    <div class="md-card-list-item-menu" data-uk-dropdown="{mode:'click',pos:'bottom-right'}">
                                        ...
                                        <div class="uk-dropdown uk-dropdown-small">
                                            <ul class="uk-nav">
                                                <li><a href="pages_staff_view_reply.php?sm_id=<?php echo $row->sm_id;?>"><i class="material-icons uk-text-primary">reply</i> View Reply</a></li>
                                            </ul>
                                            <ul class="uk-nav">
                                                <li><a href="pages_staff_manage_sendmails.php?deleteMail=<?php echo $row->sm_id;?>"><i class="material-icons uk-text-danger">delete_forever</i> Delete</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <li>
                                        ...
                                        <div class="md-card-list-item-sender">
                                            <span><?php echo $row->sm_receiverNo;?> <?php echo $row->sm_receiverName;?></span>
                                        </div>
