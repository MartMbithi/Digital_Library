<?php
    ...
    if(isset($_GET['deleteMail']))
   {
         ...
         $adn="DELETE FROM  iL_receivedMails  WHERE rm_id = ?";
            ...
            <div class="md-card-list-wrapper" id="mailbox">
                <div class="uk-width-large-8-10 uk-container-center">
                    <div class="md-card-list">
                        <div class="md-card-list-header heading_list">Incomming Mail</div>
                        <div class="md-card-list-header md-card-list-header-combined heading_list" style="display: none">
                            All Incomming Mails
                        </div>
                        <!--Start Messanges-->
                            <?php
                                $ret="SELECT * FROM  iL_sendMails  WHERE sm_receiverName = 'Library Staff'"; 
                                ...
                                <ul class="hierarchical_slide">
                                    <div class="md-card-list-item-menu" data-uk-dropdown="{mode:'click',pos:'bottom-right'}">
                                        ...
                                        <div class="uk-dropdown uk-dropdown-small">
                                            ...
                                            <ul class="uk-nav">
                                                <li><a href="pages_staff_manage_sendmails.php?deleteMail=<?php echo $row->rm_id;?>"><i class="material-icons uk-text-danger">delete_forever</i> Delete</a></li>
                                                <li><a href="pages_staff_reply.php?sm_id=<?php echo $row->sm_id;?>"><i class="material-icons uk-text-primary">reply</i>Reply</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <li>
                                        ...
                                        <div class="md-card-list-item-sender">
                                            <span>From : <?php echo $row->sm_senderName;?></span>
                                        </div>
