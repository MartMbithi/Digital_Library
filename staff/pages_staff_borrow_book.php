<?php 
    ...
    if(isset($_POST['borrow_book']))
    {
        ...
        //bind paramaters
        $rc=$stmt->bind_param('ssssssssssss', $b_title, $b_isbn_no, $bc_id, $bc_name, $lo_type, $b_id, $lo_number, $s_id, $s_name, $s_number, $lo_checksum, $lo_return_date);
     ...
     <!--Breadcrums-->
            <div id="top_bar">
                <ul id="breadcrumbs">
                    ...
                    <li><a href="pages_staff_new_library_book_borrow_operation.php">Library Operations</a></li>
