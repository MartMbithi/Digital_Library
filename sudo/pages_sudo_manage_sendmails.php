                                ...
                                <ul class="hierarchical_slide">
                                    <div class="md-card-list-item-menu" data-uk-dropdown="{mode:'click',pos:'bottom-right'}">
                                        ...
                                        <div class="uk-dropdown uk-dropdown-small">
                                            <ul class="uk-nav">
                                                <li><a href="pages_sudo_view_reply.php?sm_id=<?php echo $row->sm_id;?>"><i class="material-icons">&#xE872;</i> View Reply</a></li>
                                            </ul>
                                            <ul class="uk-nav">
                                                <li><a href="pages_sudo_manage_sendmails.php?deleteMail=<?php echo $row->sm_id;?>"><i class="material-icons">&#xE872;</i> Delete</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <li>
