<?php
    ...
    if(isset($_GET['RollBack']))
   {
         ...
         $stmt->close();	 
            ...
            if($stmt)
            {
                $info = "Library Operation Record Deleted";
            }
            else
            {
                $err = "Try Again Later";
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href='pages_sudo_view_library_operations.php?operationChecksum=<?php echo $row->lo_checksum;?>'>
                                                <span class='uk-badge uk-badge-success'>View</span>
                                        </a>
                                        <a href='pages_sudo_manage_library_operations.php?RollBack=<?php echo $row->lo_id;?>'>
