<?php 
    ...
    if(isset($_POST['changePassword']))
    {
        ...
        if($stmt && $stmt1)
        {
            $success = "Student Account Password Reset" && header("refresh:1;url=pages_sudo_manage_student_password_resets.php");
        }
        else 
        {
        ...
        <div id="page_content">
            ...
            <div id="top_bar">
                <ul id="breadcrumbs">
                    ...
                    <li><a href="pages_sudo_manage_student_password_resets.php">Password Resets</a></li>
