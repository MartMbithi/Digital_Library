            ...
            <ul>
                ...
                <li title="Librarians">
                    <a href="#">
                        ...
                        <span class="menu_title">Librarians</span>
                    </a>
                    <ul>
                ...
                <li title="Books Inventory">
                    ...
                    <ul>
                        <li><a href="pages_sudo_new_book_category.php">Add Book Category</a></li>
                        <li><a href="pages_sudo_manage_categories.php">Manage Categories</a></li>
                ...
                <li title="Library Operations">
                    ...
                    <ul>
                        <li><a href="pages_sudo_new_library_operation.php">Add</a></li>
                        <li><a href="pages_sudo_manage_library_operations.php">Manage</a></li>
                ...
                <li title="Library Finances">
                    ...
                    <ul>
                        <li><a href="pages_sudo_new_finance_record">Add</a></li>
                        <li><a href="pages_sudo_manage_finances.php">Manage</a></li>
