        ...
        <div id="page_content">
            ...
            <div id="top_bar">
                <ul id="breadcrumbs">
                    ...
                    <li><a href="pages_sudo_view_subscription.php">Manage Subscription</a></li>
                            ...
                            <div class="user_content">
                                ...
                                <div class="md-card md-card-hover">
                                        <div class="gallery_grid_item md-card-content">
                                            <a href="pages_sudo_view_magazine.php?s_id=<?php echo $row->s_id;?>" class="custom-modal-open" data-image-id="7">
