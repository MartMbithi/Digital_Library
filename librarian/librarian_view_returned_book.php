                                ...
                                <div class="sparkline10-graph">
                                    <div class="static-table-list">
                                        <table class="table border-table">
                                            ...
                                            $ret="SELECT *  FROM client  where book_return_status =''";
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><a  class="fa fa-check"  href='librarian_view_single_returned_book.php?client_id=<?php echo $row->client_id;?>'></a></td>
