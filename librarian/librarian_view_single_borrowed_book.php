...
if(isset($_POST['approve_borrowing']))
{
        ...
        $book_borr_status=$_POST['book_borr_status'];

        $query="update client set  book_name=?, isbn_no=?, category=?, book_borr_status=?  where client_id=?";
        $stmt = $mysqli->prepare($query);
        $rc=$stmt->bind_param('ssssi',  $book_name, $isbn_no, $category, $book_borr_status, $id);
        $stmt->execute();
                            ...
                            <div class="sparkline12-list shadow-reset mg-t-30">
                                <div class="sparkline12-hd">
                                    <div class="main-sparkline12-hd">
                                        <h1>Fill All Book Borrowing Details: </h1>
                                                    ...
                                                    <form  method ="POST"  enctype="multipart/form-data" action="#">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input type="text"  name= "book_borr_status" hide id="book_borr_status" value="Approved" readonly required class="form-control" />
                                                                </div>
                                                            </div>
                                                        </div>
