...
if(isset($_POST['approve_return']))
{
        ...
        $book_return_status=$_POST['book_return_status'];

        $query="update client set  book_name=?, isbn_no=?, category=?, book_return_status=?  where client_id=?";
        $stmt = $mysqli->prepare($query);
        $rc=$stmt->bind_param('ssssi',  $book_name, $isbn_no, $category, $book_return_status, $id);
        $stmt->execute();

        echo"<script>alert('Success!  Book Return Approved');</script>";
}
?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Approve Return</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline12-list shadow-reset mg-t-30">
                                <div class="sparkline12-hd">
                                    <div class="main-sparkline12-hd">
                                        <h1>Fill All Book Return Details: </h1>
                                                    ...
                                                    <form  method ="POST"  enctype="multipart/form-data" action="#">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input type="text"  name= "book_return_status" hide id="book_return_status" value="Approved" readonly required class="form-control" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <div class="login-horizental cancel-wp pull-left">
                                                                            ...
                                                                            <button class="btn btn-sm btn-primary login-submit-cs" type="submit" name="approve_return">Approve Return</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
