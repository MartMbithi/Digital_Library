...
if(isset($_POST['approve_borrowing']))
{
        ...
        $book_lost_status=$_POST['book_lost_status'];

        $query="update client set  book_name=?, isbn_no=?, category=?, book_lost_status=?  where client_id=?";
        $stmt = $mysqli->prepare($query);
        $rc=$stmt->bind_param('ssssi',  $book_name, $isbn_no, $category, $book_lost_status, $id);
        $stmt->execute();

        echo"<script>alert('Success! Book Marked As Lost ');</script>";
}
?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Lost Books</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline12-list shadow-reset mg-t-30">
                                <div class="sparkline12-hd">
                                    <div class="main-sparkline12-hd">
                                        <h1>Lost Book Awaiting Approval Details: </h1>
                                                    ...
                                                    <form  method ="POST"  enctype="multipart/form-data" action="#">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input type="text"  name= "book_lost_status" hide id="book_lost_status" value="Approved" readonly required class="form-control" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <div class="login-horizental cancel-wp pull-left">
                                                                            ...
                                                                            <button class="btn btn-sm btn-primary login-submit-cs" type="submit" name="approve_borrowing">Approve</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
