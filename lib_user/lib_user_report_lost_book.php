...
//sql to inset the values to the database
    $query="update client set  book_name=?, category=?, book_lost_status='Pending', isbn_no=? where client_id=?";
    $stmt = $mysqli->prepare($query);
    //bind the submitted values with the matching columns in the database.
    $rc=$stmt->bind_param('sssi',$book_name, $category, $isbn_no, $cid);
    $stmt->execute();
    //if binding is successful, then indicate that a new value has been added.
    echo"<script>alert('Success! You Have Reported This Book Is Lost');</script>";
}
?>
       ...
       <?php include("includes/headbar.php");?>
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Dashboard / Report Lost Book </h1>
            <?php
      	 ...
      	 //$cnt=1;
      	   while($row=$res->fetch_object())
      	  {
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Report  <u><b> <?php echo $row->book_name;?></b></u>  As Lost Book</h6>
                ...
                <div class="card-body">
                  ...
                  <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <input type="submit" name="lib_user_borrow_book" class="btn btn-primary" value="Report Lost Book" /> 
                </form>
            <?php }?>
