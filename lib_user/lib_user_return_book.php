       ...
       <?php include("includes/headbar.php");?>
        ...
        <?php
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Dashboard / Borrowed Book  </h1>
              ...
              <div class="card shadow mb-4">
                ...
                <table class="table table-bordered">
                    <thead>
                        ...
                        <th scope="col">Date Book Borrowed</th>
                    ...
                    <tbody>
                        ...
                        <td><?php echo $row->book_borr_status ;?></td>
                       <td><a  class="btn btn-outline-success"  href='lib_user_return_borrowed_book.php?client_id=<?php echo $row->client_id;?>'>Return</a></td>
                        </tr>
