...
<body class="disable_transitions sidebar_main_open sidebar_main_swipe">
    ...
    <!--BreadCrumps-->
        ...
        <div id="page_content_inner">
            ...
            <h4 class="heading_a uk-margin-bottom">My Finance Records</h4>
                ...
                <div class="md-card-content">
                    ...
                    <table id="dt_tableExport" class="uk-table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <?php
                                $id = $_SESSION['s_id'];
                                $ret="SELECT * FROM  iL_Fines WHERE s_id =? "; 
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            if($row->f_status == '')
                                            {
                                                echo 
                                                "
                                                    <a href='pages_std_pay_fine.php?fineId=$row->f_id'>
                                            ...
                                            else
                                            {
                                                echo 
                                                "
                                                    <a href='pages_std_get_receipt.php?fineId=$row->f_id&s_id=$row->s_id'>
