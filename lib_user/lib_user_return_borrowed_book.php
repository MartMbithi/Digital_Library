...
//sql to inset the values to the database
    $query="update client set  book_name=?, category=?, isbn_no=?, date_returned=? where client_id=?";
    $stmt = $mysqli->prepare($query);
    //bind the submitted values with the matching columns in the database.
    $rc=$stmt->bind_param('ssssi',$book_name, $category, $isbn_no, $date_returned, $cid);
    $stmt->execute();
    //if binding is successful, then indicate that a new value has been added.
    echo"<script>alert('Success! You Have Returned This Book');</script>";
}
?>
            ...
            <div class="col-xl-12 col-lg-6">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Return <?php echo $row->book_name;?></h6>
                ...
                <div class="card-body">
                  ...
                  <form action="" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" readonly name="book_name" id="book_name" aria-describedby="emailHelp" value="<?php echo $row->book_name;?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"   name="date_returned"   class="form-control" id="date_returned" value="<?php echo date('M D Y');?>" aria-describedby="emailHelp">
                    </div>
                    
                    
                   
                    <input type="submit" name="lib_user_borrow_book" class="btn btn-primary" value="Return Book" /> 
                </form>
            <?php }?>
